...
def collect_systems():
    ...
    try:
        corp = _load(os.path.join(ROOT, "governance/corporate/corporate_node.py"), "corp2b")
        for nd in _nodes_or_skip(corp.build_node):
            out.append((nd, "contrast"))
    except Exception:                                # noqa: BLE001
        pass
    try:
        nc = _load(os.path.join(ROOT, "natural-systems/negative-controls/real_controls.py"), "nc4real")

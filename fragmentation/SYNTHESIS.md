...
review), `census/governance/` (designed-system fracture), `discovery/` +
`integration/` + `natural-systems/` + `governance/` (the original discovery engine
+ domain nodes + sealed-holdout confirmations).*

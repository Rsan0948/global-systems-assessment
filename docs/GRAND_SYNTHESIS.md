...
> This is a synthesis essay and research agenda. It is not the claims
> authority. Historical confidence labels in this document must be read
> through `mi-research/docs/CLAIMS_LEDGER.md`. The ledger records the
> evidence design, verdict, scope, and current corpus counts.

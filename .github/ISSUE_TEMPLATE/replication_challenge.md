...
Different numbers on a fresh clone are the most valuable issue this repo
...
**Expected value** (number + where stated: doc, ledger, REPRODUCE.md)
...
upstream, give source versions, e.g. V-Dem v15, WGI 2024)

**Environment**

**Notes** (anything you changed, however small)
